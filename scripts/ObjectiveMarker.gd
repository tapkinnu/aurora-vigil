...
func _build() -> void:
	...
	icon_mesh.size = Vector3(3.4, 3.4, 3.4)
	...
	halo_mesh.inner_radius = 3.4
	halo_mesh.outer_radius = 4.4
	halo.mesh = halo_mesh
...
func _beam_material() -> StandardMaterial3D:
	var mat := StandardMaterial3D.new()
	mat.albedo_color = Color(marker_color.r, marker_color.g, marker_color.b, 0.28)
	mat.emission_enabled = true
	mat.emission = marker_color
